...
const Register = () => {
  const [form, setForm] = useState({
    name: "", email: "", password: "", role: "consumer", city: ""
  });
    ...
    >
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <div
              style={{
                ...
                background: "#e05c2a", borderRadius: "8px",
        ...
        >
          ...
          >
            Join PharmaTracker Today
          </h1>
          <p style={{ fontSize: "0.95rem", opacity: 0.75 }}>
            Create your account and start tracking pharmaceutical
            prices across India in real time.
          </p>
        </div>
      </div>
        ...
        <div style={{ width: "100%", maxWidth: "380px" }}>
          <h2
            style={{
              ...
              marginBottom: "0.25rem", color: "#111",
            }}
          >
            Create Account 🚀
          </h2>
          ...
          >
            ...
            <span style={{ padding: "0 1rem", color: "#888", fontSize: "0.85rem" }}>
              or
            </span>
            <div style={{ flex: 1, height: "1px", background: "#e5e7eb" }} />
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.65rem" }}>
            ...
            <button
              style={{
                ...
                fontSize: "0.9rem", fontWeight: "500", color: "#111",
              }}
            >
